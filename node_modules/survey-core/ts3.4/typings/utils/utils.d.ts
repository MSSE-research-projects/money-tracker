...
declare function confirmActionAsync(message: string, funcOnYes: () => void, funcOnNo?: () => void): void;
...
export declare function showConfirmDialog(message: string, callback: (res: boolean) => void, applyTitle?: string): boolean;
